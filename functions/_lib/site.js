...
body{background:radial-gradient(ellipse at 50% -8%,rgba(255,255,255,.98) 0,rgba(255,255,255,.54) 32%,rgba(255,255,255,0) 62%),linear-gradient(180deg,#fafaf8 0%,#f4f4f1 48%,#eeeeea 100%);background-attachment:fixed}
