...
exports.handler = async function(event) {
  ...
  const lead = lang === 'en' ? 'This index is generated from live data so that dictionary entries can be read directly by search engines.' : 'Bu dizin, sözlük maddelerinin arama motorları tarafından doğrudan okunabilmesi için canlı veriden üretilir.';
